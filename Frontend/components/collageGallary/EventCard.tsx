  ...
  return (
    ...
    >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-3">
          <span className="text-xs font-medium bg-amber-600 text-white px-2 py-1 rounded-full">
            {event.category}
          </span>
      </div>
      ...
      <div className="absolute inset-0 border-2 border-transparent group-hover:border-teal-500 rounded-xl pointer-events-none transition-colors duration-300"></div>
    </div>
  );
};
